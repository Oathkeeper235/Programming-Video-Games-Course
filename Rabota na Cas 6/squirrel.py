...
# БАРАЊЕ 3
CAMERASLACK_X = 120  # how far from the center the squirrel moves before moving the camera (x-axis)
CAMERASLACK_Y = 60  # how far from the center the squirrel moves before moving the camera (y-axis)

# БАРАЊЕ 1
# MOVERATE = 9  # how fast the player moves
# BOUNCERATE = 6  # how fast the player bounces (large is slower)
MOVERATE = 14  # Increase the player's movement speed
BOUNCERATE = 10  # Decrease the player's bouncing speed (large is slower)
BOUNCEHEIGHT = 30  # how high the player bounces
STARTSIZE = 25  # how big the player starts off
WINSIZE = 300  # how big the player needs to be to win
# БАРАЊЕ 2
# INVULNTIME = 2  # how long the player is invulnerable after being hit in seconds
INVULNTIME = 4  # Increase the time the player is invulnerable to 4 seconds
...
def runGame():
    ...
    while True:  # main game loop
        ...
        flashIsOn = round(time.time(), 1) * 5 % 2 == 1  # Decrease the flashing interval to 1/5th of a second
